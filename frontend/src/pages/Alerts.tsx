...
const setSevFilter = useAlertUIStore((s) => s.setSevFilter);
  const setCopilotOpen = useUIStore((s) => s.setCopilotOpen); console.log("Copilot Hook Initialized:", !!setCopilotOpen);
    ...
    <div className="shell">
      ...
      <div className="body">
        <nav className="sidebar">
          ...
          <button type="button" className="sb-btn" title="AI Copilot" onClick={() => setCopilotOpen(true)}><i className="ti ti-robot" /><span className="tt">AI Copilot</span></button>
          <div className="sb-sep" />
